...
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.ResultViewHolder>{

    private Activity activity;
    private Context ctx;
    private List<AssessmentResult> resultList;

    public RecordAdapter(Activity activity, Context context, List<AssessmentResult> resultList) {
    ...
    public void onBindViewHolder(@NonNull ResultViewHolder holder, int position) {
        ...
        Course currentCourse = new Database(ctx).getCourseDetails(currentResult.getCourse_id());


        holder.studentName.setText(currentCourse.getCourse_title());
